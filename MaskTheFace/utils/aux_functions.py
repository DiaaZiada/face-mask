...
def mask_image(image_path, args):
    ...
    mask_type = ["surgical", "N95", "KN95", "cloth", "gas"][random.randint(0, len(["surgical", "N95", "KN95", "cloth", "gas"])-1)]# args.mask_type
    ...
    for (i, face_location) in enumerate(face_locations):
        ...
        data["bbox"].append(face_location)
    ...
    return masked_images, mask, mask_binary_array, original_image, data
